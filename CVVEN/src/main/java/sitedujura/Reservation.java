...
public class Reservation extends javax.swing.JFrame{
    ...
    public Reservation() {
        ...
        try 
        {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM `Evenements` WHERE `Organisateur` = '"+LoginSession.NomUtil+"'");
            
            
            
            while(resultSet.next())
            {
                String reserv = String.valueOf(resultSet.getInt("Id"));
                String Date_reserv = resultSet.getString("Date_reserv");
                String Date_debut = resultSet.getString("Date_debut");
                String Date_depart = resultSet.getString("Date_depart");
                String Desc = resultSet.getString("Description");
                String Type = resultSet.getString("Type");
                String Organisateur = resultSet.getString("Organisateur");
                
                String tbData[] = {reserv,Date_reserv,Date_debut,Date_depart,Type,Desc,Organisateur};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero de reserv", "Date reserv", "Date d'arrivée", "Date de départ", "Type", "Description", "Organisateur"
            }
        ) {
